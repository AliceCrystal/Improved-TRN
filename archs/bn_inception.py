...
def bninception(pretrained='imagenet'):
    ...
    if pretrained is not None:
        ...
        # because i cannot load the pretrained BNInception model
        # model.load_state_dict(model_zoo.load_url(settings['url']))
        BNInc_model_path = '/home/amax/.cache/torch/checkpoints/bn_inception_caffe-ed2e8665.pth'
        model.load_state_dict(torch.load(BNInc_model_path))
