...
parser.add_argument('--dataset', type=str, choices=['something','jester','moments','charades'], default='something')
parser.add_argument('--modality', type=str, choices=['RGB', 'Flow', 'RGBDiff'], default='RGB')
parser.add_argument('--weights', type=str, default='pretrain/TRN_something_RGB_BNInception_TRNmultiscale_segment8_best.pth.tar')
...
np.save('video_scores.npy', video_scores)
